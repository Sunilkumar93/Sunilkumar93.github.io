    ...
    <Box>
      ...
      <SimpleGrid columns={{sm: 1, md: 2}} justifyContent="space-around" mt={[0, 4, 6, 8]}>
        <Box p={[4, 8, 14, 20]} textAlign="justify">
          <Text fontSize='xl'>Hello, World! I am Sunil Kumar A MERN stack developer, with 1200+ hours of coding experience, prectice 300+ hours of Data structure and algorithms.</Text>
